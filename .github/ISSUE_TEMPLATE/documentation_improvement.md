...
2. Check out and follow our Guidelines: https://github.com/EndemolShineGroup/generator-codebuild/blob/develop/CONTRIBUTING.md
...
***Version of `generator-codebuild` you're using***:
